# -*- coding: utf-8 -*-
#
# xrd-analysis documentation build configuration file, created by
# sphinx-quickstart.
#
...
# state it here. needs_sphinx = '1.0'
...
# all documents. default_role = None
...
htmlhelp_basename = "xrd-analysisdoc"
