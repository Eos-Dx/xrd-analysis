...
class TestPatientCancerClusterEstimator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        label_name = "cluster"
        columns = ["Patient_ID", feature_name, label_name, "Diagnosis"]
    ...
    def test_patient_cancer_cluster_estimator_accuracy_threshold_nonzero_large(self):
