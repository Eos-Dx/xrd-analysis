...
if "hardware.eosdxdc.gui.technical.widgets" not in sys.modules:
    w_mod = types.ModuleType("hardware.eosdxdc.gui.technical.widgets")
    ...
    sys.modules["hardware.eosdxdc.gui.technical.widgets"] = w_mod

# Stub logger module
if "hardware.eosdxdc.utils.logger" not in sys.modules:
    l_mod = types.ModuleType("hardware.eosdxdc.utils.logger")
    ...
    sys.modules["hardware.eosdxdc.utils.logger"] = l_mod
...
class TestMeasurementPointFiltering(unittest.TestCase):
    ...
    @patch("hardware.eosdxdc.hardware.auxiliary.encode_image_to_base64")
