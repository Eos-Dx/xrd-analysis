"""EOSDxDc utilities package.

Logging utilities for the EOSDxDc application. Use setup_logging() or
...
then use either the stdlib "logging" or hardware.eosdxdc.utils.logger helpers.
