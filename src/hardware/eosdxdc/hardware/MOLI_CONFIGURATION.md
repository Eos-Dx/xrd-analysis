...
### 1. `Ulster (Moli).json`
**Location:** `src/hardware/eosdxdc/resources/config/setups/Ulster (Moli).json`
...
**Location:** `src/hardware/eosdxdc/hardware/hardware_control.py`
...
```bash
cd C:\dev\xrd-analysis\src\hardware\eosdxdc\hardware
