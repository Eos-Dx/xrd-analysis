...
class PreprocessData(object):
    ...
    def find_eye_rotation_angle(self, image, center):
        ...
        peaks = peak_local_max(eye_roi, min_distance=int(np.ceil(1.5*peak_location_radius_9A_theory)))
        ...
        line = gen_rotation_line(center=center, angle=angle)

        import matplotlib.pyplot as plt
        f, axs = plt.subplots(1, 3, figsize=(12,4))

        axs[0].imshow(20*np.log10(image+1), cmap="hot")
        axs[0].scatter(center[1], center[0], c="green")
        axs[0].plot(line[0], line[1], c="blue")

        axs[1].imshow(masked_image, cmap="hot")
        axs[1].scatter(center[1], center[0], c="green")
        axs[1].scatter(peak_location[1], peak_location[0], c="green")
        axs[1].scatter(blob_centroid[1], blob_centroid[0], c="blue")

        axs[2].imshow(eye_roi, cmap="hot")
        axs[2].scatter(center[1], center[0], c="green")
        axs[2].scatter(peak_location[1], peak_location[0], c="green")
        axs[2].scatter(blob_centroid[1], blob_centroid[0], c="blue")

        # print(center, peak_location, blob_centroid, angle)

        plt.savefig(self.timestamp + ".png")
