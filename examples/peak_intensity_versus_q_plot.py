...
def plot_peak_intensity_versus_q(data_list_filepath, cancer_df_filepath):
    ...
    for filepath in filepath_list:
        ...
        peak_indices = find_peaks_cwt(mean_intensity_profile, range(7,15))
